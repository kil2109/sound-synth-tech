...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "int", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 741.246673583984375, 303.5, 288.0, 153.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 21.312500000000114, 469.0, 203.0, 22.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
					"text" : "spat5.virtualspeakers~ @speakers 2"
				}
...
,
					"text" : "spat5.spat~ @inputs 2 @outputs 2 @rooms 1 @initwith \"/panning/type angular\"",
