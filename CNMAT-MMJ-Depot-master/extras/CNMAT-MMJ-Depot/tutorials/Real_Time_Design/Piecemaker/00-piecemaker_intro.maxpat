...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"args" : [ "CNMAT Electroacoustic Tutorials", "v0.1", "Michael Zbyszynski", "CNMAT Electroacoustic Tutorials", 6666, "0. 0.787109 0.96875 1." ],
					"id" : "obj-25",
					"maxclass" : "bpatcher",
					"name" : "badge.maxpat",
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 236.5, 666.0, 322.0, 72.0 ]
				}

			}
, 			{
				"box" : 				{
					"args" : [ "CNMAT Electroacoustic Tutorials", "Electroacoustic tutorials focusing on real time design", "0. 0.717773 0.9375 1." ],
					"id" : "obj-24",
					"lockeddragscroll" : 1,
					"maxclass" : "bpatcher",
					"name" : "banner.maxpat",
					...
					"numoutlets" : 0,
					"offset" : [ -18.0, -68.0 ],
					"patching_rect" : [ 36.0, 32.0, 511.0, 76.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 493.0, 280.0, 101.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 82.0, 437.0, 609.0, 74.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 82.0, 513.0, 607.0, 60.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 82.0, 336.0, 614.0, 87.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 484.0, 262.0, 183.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 275.0, 263.0, 158.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 98.0, 283.0, 149.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 274.0, 283.0, 207.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 82.0, 171.0, 612.0, 60.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 98.0, 263.0, 131.0, 22.0 ],
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "z.nav_buttons-ea.maxpat",
				"bootpath" : "/Users/jml/Documents/CNMAT/repositories/CNMAT-MMJ-Depot/extras/tutorials/Real_Time_Design/Piecemaker",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
