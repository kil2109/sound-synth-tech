...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 262.0, 467.0, 381.0, 117.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 365.0, 413.0, 48.0, 17.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 365.0, 434.0, 103.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 74.0, 201.0, 60.0, 17.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 274.0, 143.0, 60.0, 17.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 326.0, 332.0, 130.0, 47.0 ],
					"text" : "vexpr est un object de Max qui permet de faire de opérations mathématiques avec des listes"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 462.0, 299.0, 100.0, 17.0 ],
					"text" : "decay rates"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 316.0, 299.0, 100.0, 17.0 ],
					"text" : "gains"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 306.0, 197.0, 234.0, 47.0 ],
					"text" : "changer cette valeur pour transposer le modèle"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 274.0, 205.0, 29.0, 17.0 ],
					"text" : "t b f"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 274.0, 166.0, 126.0, 27.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 176.0, 330.0, 114.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 164.0, 363.0, 139.0, 17.0 ],
					"text" : "vexpr $f1 * $f2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 539.0, 393.0, 255.0, 47.0 ],
					"text" : "Ces objets sont très utiles parce qu'ils permettent d'opérer des modifications sur chaque catégorie de données séparément, puis de toutes les ré-assembler dans un nouveau modèle."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 535.0, 331.0, 267.0, 57.0 ],
					"text" : "\"deinterleave\" et \"interleave\" sont utilisés pour séparer et ré-assembler des listes en listes plus courtes. DAns le cas présent, un grand modèle de résonance est coupé en trois listes distinctes : une pour les fréquences, une pour les gains, une pour les \"decayrate\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "list" ],
					"patching_rect" : [ 164.0, 394.0, 302.0, 17.0 ],
					"text" : "interleave 3"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 74.0, 228.0, 100.0, 17.0 ]
				}
...
,
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 164.0, 249.0, 68.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 164.0, 279.0, 303.0, 17.0 ],
					"text" : "deinterleave 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 68.0, 397.0, 23.0, 15.0 ],
					"text" : "0.5"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 68.0, 355.0, 15.0, 15.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 196.0, 559.0, 27.0, 15.0 ],
					"text" : "stop"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 127.0, 559.0, 65.0, 15.0 ],
					"text" : "startwindow"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 143.0, 543.0, 69.0, 17.0 ],
					"text" : "• start audio"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 119.0, 538.0, 123.0, 43.0 ],
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 69.0, 449.0, 22.0, 122.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 68.0, 593.0, 31.0, 17.0 ],
					"text" : "dac~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 68.0, 375.0, 58.0, 17.0 ],
					"text" : "metro 500"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 68.0, 418.0, 65.0, 17.0 ],
					"text" : "resonators~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 551.0, 141.0, 266.0, 67.0 ],
					"text" : "entrelacer/désentrelacer : les objets \"interleave\" et \"deinterleave\""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 170.0, 299.0, 100.0, 17.0 ],
					"text" : "fréquences"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 301.0, 365.0, 28.0, 17.0 ],
					"text" : "<---"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 525.0, 326.0, 283.0, 121.0 ],
					"rounded" : 0,
					"shadow" : 2
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 545.0, 130.0, 276.0, 93.0 ],
					"rounded" : 0,
					"shadow" : 2
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 205.5, 583.0, 77.5, 583.0 ],
					"source" : [ "obj-22", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 136.5, 583.0, 77.5, 583.0 ],
					"source" : [ "obj-23", 0 ]
				}
