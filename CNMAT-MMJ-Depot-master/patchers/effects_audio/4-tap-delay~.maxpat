...
,
					"patching_rect" : [ 168.0, 80.0, 55.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 168.0, 58.0, 91.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 97.0, 75.0, 64.0, 17.0 ],
					"text" : "patcherargs"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 168.0, 36.0, 15.0, 15.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 168.0, 103.0, 65.0, 17.0 ],
					"text" : "unpack f f f f"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 131.0, 241.0, 15.0, 15.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 262.0, 139.0, 73.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 262.0, 77.0, 15.0, 15.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 76.0, 103.0, 69.0, 17.0 ],
					"text" : "tapin~ 10000"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 81.0, 139.0, 153.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 128.0, 186.0, 39.0, 17.0 ],
					"text" : "*~ 0.4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 175.0, 186.0, 45.0, 17.0 ],
					"text" : "*~ 0.25"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 222.0, 186.0, 39.0, 17.0 ],
					"text" : "*~ 0.1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 35.0, 186.0, 39.0, 17.0 ],
					"text" : "*~ 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 81.0, 186.0, 39.0, 17.0 ],
					"text" : "*~ 0.6"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 76.0, 77.0, 15.0, 15.0 ]
				}
