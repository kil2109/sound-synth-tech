...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"args" : [ "int+frac", "output the integer part to left outlet and the fractional part to right outlet.", "0.517 0.512 0.638 1." ],
					"id" : "obj-18",
					"lockeddragscroll" : 1,
					"maxclass" : "bpatcher",
					"name" : "banner.maxpat",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 199.5, 222.0, 154.0, 33.0 ],
