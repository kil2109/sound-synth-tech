...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 156.0, 168.5, 53.0, 27.0 ],
					"text" : "input",
					"textcolor" : [ 0.588235, 0.588235, 0.705882, 1.0 ]
				}
...
, 			{
				"box" : 				{
					"args" : [ "only-positive~", "half-wave rectifier", "0.517 0.512 0.638 1." ],
					"id" : "obj-8",
					"lockeddragscroll" : 1,
					"maxclass" : "bpatcher",
					"name" : "banner.maxpat",
...
, 			{
				"box" : 				{
					"args" : [ "only-positive~.help", "1.2a", "Wright & Zbyszynski", "only-positive~", 4182, "0.517 0.512 0.638 1." ],
					"id" : "obj-9",
					"maxclass" : "bpatcher",
					"name" : "badge.maxpat",
					"numinlets" : 0,
