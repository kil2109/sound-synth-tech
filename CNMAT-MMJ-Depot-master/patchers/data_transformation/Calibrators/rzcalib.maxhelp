...
, 			{
				"box" : 				{
					"args" : [ "rzcalib.help", "1.1b", " Zbyszynski", "rzcalib", 2824, "0.517 0.512 0.638 1." ],
					"id" : "obj-53",
					"maxclass" : "bpatcher",
					"name" : "badge.maxpat",
					"numinlets" : 0,
...
, 			{
				"box" : 				{
					"args" : [ "rzcalib", "adjusts a running stream of numbers to a range, and adjusts zero point", "0.517 0.512 0.638 1." ],
					"id" : "obj-48",
					"lockeddragscroll" : 1,
					"maxclass" : "bpatcher",
					"name" : "banner.maxpat",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 368.0, 288.0, 164.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 148.0, 229.0, 192.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 355.0, 313.0, 123.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 354.0, 269.0, 136.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 354.0, 246.0, 110.0, 22.0 ],
					"text" : "3) Sweep to low",
					"textcolor" : [ 0.6, 0.6, 0.701961, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 354.0, 222.0, 116.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 354.0, 198.0, 175.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 131.0, 415.0, 100.0, 33.0 ],
					"text" : "^"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 67.0, 103.0, 100.0, 33.0 ],
					"text" : "v"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 194.0, 103.0, 100.0, 33.0 ],
					"text" : "v"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 158.0, 147.0, 100.0, 33.0 ],
					"text" : "^"
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "rzcalib.maxpat",
				"bootpath" : "/Users/jml/Documents/materials/programming/max_files/5_berkeley/projects/cnmat/repositories/git/CNMAT-MMJ-Depot/patchers/data_transformation/Calibrators",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
