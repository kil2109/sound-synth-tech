...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 308.0, 400.0, 444.0, 61.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 51.0, 290.0, 35.0, 22.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 145.0, 290.0, 47.0, 22.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 435.0, 347.0, 62.0, 22.0 ],
					"text" : "multibuf"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 51.0, 326.0, 157.0, 22.0 ],
					"text" : "mono-msp-nl"
				}
...
, 			{
				...
				"bootpath" : "/Users/jml/Documents/materials/programming/max_files/5_berkeley/projects/cnmat/repositories/git/CNMAT-MMJ-Depot/media/Colls-Tables",
