...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"args" : [ "random-in-range", 1.0, "Matt Wright / Jeff Lubow", "random-in-range", 6666, "0.169 0.149 0.1671. 0.5" ],
					"id" : "obj-20",
					"maxclass" : "bpatcher",
					"name" : "badge.maxpat",
					"numinlets" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 481.0, 202.0, 38.0, 17.0 ],
					"text" : "10 20",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 481.0, 229.0, 32.5, 17.0 ],
					"text" : "3 49",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					"args" : [ "random-in-range", "choose a number between a min and max", "0.169 0.149 0.1671. 0.5" ],
					"id" : "obj-18",
					"lockeddragscroll" : 1,
					"maxclass" : "bpatcher",
					"name" : "banner.maxpat",
