...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"args" : [ "CNMAT MMJ Depot Overview", "Overview of CNMAT's Max/MSP/Jitter Depot", "0.517 0.512 0.638 1." ],
					"id" : "obj-42",
					"lockeddragscroll" : 1,
					"maxclass" : "bpatcher",
					"name" : "banner.maxpat",
					...
					"numoutlets" : 0,
					"offset" : [ -21.0, -68.0 ],
					"patching_rect" : [ 7.0, 6.0, 503.0, 77.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 930.0, 94.0, 50.0, 18.0 ],
					"text" : "-4703"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 870.0, 64.0, 115.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 12.0, 85.0, 774.0, 27.0 ],
					"spacing_y" : 0.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, -20.0 ],
					"patching_rect" : [ 10.0, 111.0, 778.0, 580.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 223.0, 704.0, 242.0, 29.0 ]
				}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 13.0, 608.0, 1352.0, 27.0 ],
...
,
					"patching_rect" : [ 18.0, 701.0, 184.0, 27.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 443.0, 62.0, 57.0, 17.0 ],
					"text" : "loadmess 0"
				}
...
,
					"patching_rect" : [ 791.0, 104.0, 64.0, 17.0 ],
					"saved_object_attributes" : 					{
						"tags" : "",
						"description" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 845.0, 127.0, 61.0, 17.0 ],
...
, 			{
				"box" : 				{
					"args" : [ "CNMAT_MMJD_Overview", "2.1a", "Valle, Zbyszynski", "CNMAT_MMJD_Overview", 7777, "0.517 0.512 0.638 1." ],
					"id" : "obj-27",
					"maxclass" : "bpatcher",
					"name" : "badge.maxpat",
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 489.0, 692.0, 292.0, 86.0 ]
				}
